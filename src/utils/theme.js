export const hexToHsl = (hex) => {
        ...
        export const THEME_INDUSTRY_FILTERS = [
            ...
            { id: 'hair', name: 'Hair Salon', hint: 'Stylists, Colour, Blowouts', swatches: ['#111111', '#F8E7D2', '#C084FC'], match: (theme) => hasThemeTag(theme, 'industryTags', ['hair', 'beauty']) },
            { id: 'barber', name: 'Barber', hint: 'Cuts, Grooming, Shaves', swatches: ['#050505', '#F8FAFC', '#2563EB'], match: (theme) => hasThemeTag(theme, 'industryTags', ['barber', 'beauty']) },
            { id: 'nails', name: 'Nails', hint: 'Sets, Art, Pedicures', swatches: ['#FFF1F2', '#EC4899', '#FACC15'], match: (theme) => hasThemeTag(theme, 'industryTags', ['nails', 'beauty']) },
            { id: 'brows-lashes', name: 'Brows & Lashes', hint: 'Lifts, Tinting, Shape', swatches: ['#FAF5FF', '#8B5CF6', '#1F2937'], match: (theme) => hasThemeTag(theme, 'industryTags', ['brows-lashes', 'beauty']) },
            { id: 'waxing', name: 'Waxing', hint: 'Smooth, Quick, Clean', swatches: ['#FFF7ED', '#F97316', '#7C2D12'], match: (theme) => hasThemeTag(theme, 'industryTags', ['waxing', 'beauty']) },
            { id: 'beauty', name: 'Beauty Studio', hint: 'Salon, Makeup, Skin', swatches: ['#FFF1F2', '#EC4899', '#7C2D12'], match: (theme) => hasThemeTag(theme, 'industryTags', ['beauty']) },
            { id: 'spa', name: 'Spa & Sauna', hint: 'Quiet, Premium, Calm', swatches: ['#ECFDF5', '#10B981', '#064E3B'], match: (theme) => hasThemeTag(theme, 'industryTags', ['spa', 'wellness']) },
            { id: 'medspa', name: 'Medspa', hint: 'Clinical, Luxe, Trust', swatches: ['#EFF6FF', '#0EA5E9', '#EDE9FE'], match: (theme) => hasThemeTag(theme, 'industryTags', ['medspa', 'healthcare']) },
            { id: 'massage', name: 'Massage', hint: 'Restorative, Warm, Slow', swatches: ['#F6F7EE', '#65A30D', '#7C2D12'], match: (theme) => hasThemeTag(theme, 'industryTags', ['massage', 'wellness']) },
            { id: 'wellness', name: 'Wellness', hint: 'Therapy, Yoga, Recovery', swatches: ['#ECFDF5', '#10B981', '#064E3B'], match: (theme) => hasThemeTag(theme, 'industryTags', ['wellness']) },
            { id: 'fitness', name: 'Fitness Studio', hint: 'Gyms, Classes, Sport', swatches: ['#050505', '#39FF14', '#2563EB'], match: (theme) => hasThemeTag(theme, 'industryTags', ['fitness']) },
            { id: 'personal-training', name: 'Personal Training', hint: 'Coaches, Plans, Results', swatches: ['#020617', '#FACC15', '#14A7FF'], match: (theme) => hasThemeTag(theme, 'industryTags', ['personal-training', 'fitness']) },
            { id: 'therapy', name: 'Therapy Centre', hint: 'Care, Privacy, Trust', swatches: ['#F8FAFC', '#8B5CF6', '#64748B'], match: (theme) => hasThemeTag(theme, 'industryTags', ['therapy', 'wellness']) },
            { id: 'physical-therapy', name: 'Physical Therapy', hint: 'Recovery, Movement, Care', swatches: ['#EFF6FF', '#2563EB', '#10B981'], match: (theme) => hasThemeTag(theme, 'industryTags', ['physical-therapy', 'healthcare']) },
            { id: 'healthcare', name: 'Health Practice', hint: 'Clinic, Care, Dental', swatches: ['#EFF6FF', '#0EA5E9', '#0F766E'], match: (theme) => hasThemeTag(theme, 'industryTags', ['healthcare']) },
            { id: 'tattoo-piercing', name: 'Tattoo & Piercing', hint: 'Ink, Edge, Portfolios', swatches: ['#050505', '#FFFFFF', '#BE123C'], match: (theme) => hasThemeTag(theme, 'industryTags', ['tattoo-piercing', 'creative']) },
            { id: 'tanning', name: 'Tanning Studio', hint: 'Glow, Bronze, Sun', swatches: ['#FFF7ED', '#F97316', '#EAB308'], match: (theme) => hasThemeTag(theme, 'industryTags', ['tanning', 'beauty']) },
            { id: 'pets', name: 'Pet Grooming', hint: 'Friendly, Fresh, Care', swatches: ['#F0FDF4', '#10B981', '#FACC15'], match: (theme) => hasThemeTag(theme, 'industryTags', ['pets']) },
            ...
            { id: 'creative', name: 'Creative Studio', hint: 'Studios, Artists, Photo', swatches: ['#FAF5FF', '#A855F7', '#DB2777'], match: (theme) => hasThemeTag(theme, 'industryTags', ['creative']) },
            ...
            { id: 'food', name: 'Food & Tastings', hint: 'Chefs, Cafes, Popups', swatches: ['#FFF7ED', '#F97316', '#CA8A04'], match: (theme) => hasThemeTag(theme, 'industryTags', ['food']) },
            ...
            { id: 'home-services', name: 'Home Services', hint: 'Cleaning, Repair, Visits', swatches: ['#F8FAFC', '#10B981', '#0F172A'], match: (theme) => hasThemeTag(theme, 'industryTags', ['home-services', 'trades']) },
            { id: 'automotive', name: 'Automotive', hint: 'Detailing, Repairs, Fitment', swatches: ['#020617', '#14A7FF', '#FACC15'], match: (theme) => hasThemeTag(theme, 'industryTags', ['automotive', 'trades']) },
            ...
            { id: 'legal', name: 'Legal', hint: 'Consults, Cases, Advice', swatches: ['#F8FAFC', '#111827', '#B45309'], match: (theme) => hasThemeTag(theme, 'industryTags', ['legal', 'finance']) },
